...
const booksData = {
  ...
  thinking: {
   ...
   KillMockingbird: {
    title: '杀死一只知更鸟',
    author: '哈珀·李',
    description: '杀死一只知更鸟》是美国作家哈珀·李的代表作。小说以美国南方小镇为背景，通过儿童视角讲述了一起涉及种族歧视的不公正审判，深刻揭示了偏见、正义与道德勇气的问题，同时也展现了成长过程中对善与恶的理解。',
    quote: '"你永远不可能真正了解一个人，除非你站在他的角度看问题，钻进他的皮肤里，像他一样走来走去。 "'
  },
};
